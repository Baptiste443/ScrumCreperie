const translations = {
    fr: {
        ...
        // --- TRADUCTION NOTATION (POPUP) ---
        rate_title: "FEEDBACK_LOOP",
        rate_subtitle: "Notez votre expérience utilisateur (UX).",
        btn_send: "Envoyer le Packet",
        rating_success: "Merci ! Votre avis a été enregistré dans la base de données.",
    ...
    en: {
        ...
        // --- NOTATION EN ---
        rate_title: "FEEDBACK_LOOP",
        rate_subtitle: "Rate your User Experience (UX).",
        btn_send: "Send Packet",
        rating_success: "Thanks! Your review has been saved to the database.",
...
function submitRating(event) {
    ...
    const currentLang = localStorage.getItem('billig_lang') || 'fr';
    const message = translations[currentLang].rating_success;
    alert(message);
    closeRating();
}
